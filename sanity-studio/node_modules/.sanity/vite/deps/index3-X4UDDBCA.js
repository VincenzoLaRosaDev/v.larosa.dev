...
var IntentResolver = (0, import_react.memo)(function() {
  ...
  return $[0] !== documentStore || $[1] !== maybeIntent || $[2] !== navigate || $[3] !== rootPaneNode || $[4] !== structureContext ? (t0 = () => {
    if (maybeIntent) {
      ...
      let cancelled;
      return cancelled = false, async function() {
        const {
          id,
          type
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-PUJPHIEK.js")),
  document: (0, import_react.lazy)(() => import("./pane-IBDJFWPD.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-IBDJFWPD.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-XAU4OVXH.js"))
};
...
//# sourceMappingURL=index3-X4UDDBCA.js.map
