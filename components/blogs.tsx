...
export const Blogs = ({ className, id, paddingBlock, items }: BlogsProps) => {
      ...
      <div className="flex flex-col gap-8">
        {items?.map((item, key) => (
          <div key={key}>
            <CmsLink
              link={item.link}
              className="group flex items-start flex-col md:flex-row gap-6 p-6 rounded-lg overflow-hidden hover:bg-light-grey/5 transition-all"
            >
              <img
